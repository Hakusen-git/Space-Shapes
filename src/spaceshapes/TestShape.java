...
public class TestShape {
	...
	/**
	 * Test to check if Text is being printed correctly when the shape is painted.
	 */
	@Test
	public void testTextPainting(){
		RectangleShape shape = new RectangleShape(10,10,5,5);
		shape.addText("Text");
		shape.paint(_painter);
		shape.move(200,200);
		shape.paint(_painter);
		assertEquals("(rectangle 10,10,25,35)(paint text: Text)" +
				"(rectangle 15,15,25,35)(paint text: Text)",_painter.toString());
